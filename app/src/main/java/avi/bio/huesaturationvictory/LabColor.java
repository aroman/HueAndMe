 ...
 * Ported from Stanford's Categorical Color Components (C3)
...
public class LabColor {
    ...
    private LabColor(double L, double a, double b, int c) {
        this.L = L;
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    public LabColor copy() {
        LabColor x = new LabColor(L, a, b, c);
        if (w != null) x.w = w.clone();
        return x;
    }

    public double distance(LabColor y) {
